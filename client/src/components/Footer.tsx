...
const socials = [
  { label: "LinkedIn", href: "https://www.linkedin.com/company/infinity-x-edtech/", icon: (
  ...
  { label: "YouTube", href: "https://www.youtube.com/@infinityXEdTech", icon: (
  ...
  { label: "Facebook", href: "https://facebook.com/InfinityXEdTech", icon: (
