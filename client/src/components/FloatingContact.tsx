    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
            <a
                ...
                className="group w-13 h-13 bg-[#0088cc] rounded-2xl flex items-center justify-center text-white shadow-lg shadow-sky-500/30 hover:shadow-xl hover:shadow-sky-500/40 hover:scale-110 hover:-translate-y-0.5 transition-all duration-300 border border-sky-400/20"
            ...
            <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group w-13 h-13 bg-[#25D366] rounded-2xl flex items-center justify-center text-white shadow-lg shadow-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/40 hover:scale-110 hover:-translate-y-0.5 transition-all duration-300 border border-emerald-400/20"
