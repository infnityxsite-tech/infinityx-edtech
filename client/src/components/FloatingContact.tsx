    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
            <a
                ...
                className={`group w-13 h-13 rounded-2xl flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-110 hover:-translate-y-0.5 border backdrop-blur-md ${
                  isLight 
                    ? "bg-white/90 border-sky-100 shadow-sky-500/10 hover:shadow-xl hover:shadow-sky-500/20" 
                    : "bg-[#0088cc]/90 border-sky-400/20 shadow-sky-500/30 hover:shadow-xl hover:shadow-sky-500/40 text-white"
                }`}
                aria-label="Contact us on Telegram"
            >
                <svg viewBox="0 0 24 24" className={`w-6 h-6 transition-transform group-hover:scale-110 ${isLight ? "fill-[#0088cc]" : "fill-white"}`}>
            ...
            <a
                href="https://wa.me/201100135225"
                target="_blank"
                rel="noopener noreferrer"
                className={`group w-13 h-13 rounded-2xl flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-110 hover:-translate-y-0.5 border backdrop-blur-md ${
                  isLight 
                    ? "bg-white/90 border-emerald-100 shadow-emerald-500/10 hover:shadow-xl hover:shadow-emerald-500/20" 
                    : "bg-[#25D366]/90 border-emerald-400/20 shadow-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/40 text-white"
                }`}
                aria-label="Contact us on WhatsApp"
            >
                <svg viewBox="0 0 24 24" className={`w-6 h-6 transition-transform group-hover:scale-110 ${isLight ? "fill-[#25D366]" : "fill-white"}`}>
