        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="bg-gradient-to-br from-slate-50 to-blue-50 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-12 border border-blue-100 shadow-sm">
            ...
            <div className="md:w-2/3">
              ...
              <h3 className="text-4xl font-bold mb-6 text-slate-900 flex items-center gap-4">
                {t((pageContent as any)?.founderName || undefined, "أحمد فرحات", (pageContent as any)?.founderName || "Ahmed Farahat")}
                <a href="https://linkedin.com/in/ahmed-s-farahat" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 transition-colors" aria-label="LinkedIn Profile">
              ...
              <div className="space-y-6 text-lg text-slate-700 leading-relaxed">
                <p>
                  {t(
                    (pageContent as any)?.founderBio || "With over 5 years of experience in tech education...",
                    pageContent?.founderBioAr || "مع أكثر من 5 سنوات من الخبرة في التعليم التقني وتطوير البرمجيات...",
              ...
              <div className="mt-8 border-l-4 border-blue-600 pl-6 py-2">
                <p className="text-slate-800 italic font-medium text-xl">
                  "{t(
                    (pageContent as any)?.founderMessage || "Education is the most powerful tool...",
                    pageContent?.founderMessageAr || "التعليم هو أقوى أداة لدينا لتغيير العالم...",
